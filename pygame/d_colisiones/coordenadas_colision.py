...
while running:
    ...
    if rectangulo_x <= ball_x + 2*ball_radius <= rectangulo_x + rectangulo_ancho and \
            rectangulo_y <= ball_y + ball_radius <= rectangulo_y + rectangulo_alto:
        ball_velocity_y = -BALL_VELOCITY
    ...
    pygame.draw.rect(screen,NEGRO,[rectangulo_x,rectangulo_y,rectangulo_ancho,rectangulo_alto])
    # NO TOQUES NI ESCRIBAS CÓDIGO MÁS ALLÁ DE AQUÍ
    # -------------------------------------------------------------------------
    # -------------------------------------------------------------------------
    reloj.tick(FPS)
