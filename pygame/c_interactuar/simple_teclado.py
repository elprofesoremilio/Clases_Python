...
player_y = screen.get_height() - player_height - 50
player_velocity = 5
...
while running:
    ...
    # -------------------------------------------------------------------------
    # -------------------------------------------------------------------------
    # TODO: Manejar desde teclado

    keys = pygame.key.get_pressed()
    if keys[K_LEFT]:
        new_x = player_x - player_velocity
        if new_x > 0:
    ...
    pygame.draw.rect(screen, NEGRO, [player_x, player_y, player_width, player_height])
